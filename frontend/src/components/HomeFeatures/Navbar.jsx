...
overflow-visible'>
            ...
            {showSearch && userData.category === "consumer" && <div className='w-[90%] h-[70px] md:hidden fixed flex bg-white shadow-xl rounded-lg items-center gap-5 top-20 left-[5%]'>
...

            {
                ...
                <div className='md:w-[60%] lg:w-[40%] h-[70px] hidden md:flex bg-white shadow-xl rounded-lg items-center gap-5 '>
                    <div className='flex items-center w-[30%] overflow-hidden gap-2.5 px-2.5 border-r-2 border-gray-400'>
                        <FaLocationDot className='w-[25px] h-[25px] text-[#ff4d2d] ' />
                        <div className='w-[80%] truncate text-gray-600'>{currentCity}</div>
                    </div>
